  ...
  <div class="bg-white shadow-lg rounded-lg p-8 max-w-md w-full transform transition-transform hover:scale-105">
    ...
    <form action="/register" method="POST">
      <div class="mb-4">
        ...
        <input type="text" id="name" name="name" required class="input-field mt-1 block w-full border-gray-300 rounded-md p-2" placeholder="John Doe">
      </div>
      <div class="mb-4">
      ...
      <div class="mb-6">
        ...
        <input type="password" id="confpassword" name="confpassword" required class="input-field mt-1 block w-full border-gray-300 rounded-md p-2" placeholder="********">
      </div>
      <button type="submit" class="w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-md transition duration-300 ease-in-out transform hover:scale-105">Register</button>
    </form>
